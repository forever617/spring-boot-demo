...
public class ReturnVO {
    ...
    private static final Properties properties = ReadPropertiesUtil.getProperties(System.getProperty("user.dir") + "/studentManager/src/main/resources/response.properties");
